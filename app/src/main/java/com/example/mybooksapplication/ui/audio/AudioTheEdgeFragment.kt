...
class AudioTheEdgeFragment : Fragment() {

    private lateinit var binding: FragmentAudioTheEdgeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAudioTheEdgeBinding.inflate(layoutInflater)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        mediaPlayer = MediaPlayer.create(context, R.raw.djef)
