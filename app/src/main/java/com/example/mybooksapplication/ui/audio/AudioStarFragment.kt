...
class AudioStarFragment : Fragment() {
    private lateinit var binding: FragmentAudioStarBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAudioStarBinding.inflate(layoutInflater)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        mediaPlayer = MediaPlayer.create(context, R.raw.sovenok)
